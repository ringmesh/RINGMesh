...
if(WIN32)
    find_library(RINGMesh_LIBRARY NAMES RINGMesh PATHS ${RINGMesh_HOME}/build/ringmesh/lib/Debug)
else(WIN32)
    find_library(RINGMesh_LIBRARY NAMES RINGMesh PATHS ${RINGMesh_HOME}/build/ringmesh/${CMAKE_BUILD_TYPE}/lib)
endif(WIN32)
if(WIN32)
    find_library(GEOGRAM_LIBRARY NAMES geogram PATHS ${RINGMesh_HOME}/build/geogram/lib/Debug)
else(WIN32)
...
# Tell cmake GUIs to ignore the "local" variables. RINGMesh_DIR is defined by cmake implicitly.
