...
inline int side3_3d_filter( const double* p0, const double* p1, const double* p2, const double* p3, const double* q0, const double* q1, const double* q2) {
    ...
    else 
    {
        ...
        eps = (1.72198804259438718181e-12 * (((((max7 * max2) * max3) * max6) * max5) * max4));
        if( (r > eps) )
        {
...
inline int side3_4d_filter( const double* p0, const double* p1, const double* p2, const double* p3, const double* q0, const double* q1, const double* q2) {
    ...
    if( (max2 < fabs(q2_3_p0_3)) )
    {
        max2 = fabs(q2_3_p0_3);
    } 
    double max3 = fabs(p1_1_p0_1);
    ...
    else 
    {
        ...
        eps = (1.72443682410931985179e-13 * (((max3 * max2) * max1) * max2));
        if( (Delta > eps) )
        {
            int_tmp_result = 1;
        } 
    ...
    else 
    {
        ...
        eps = (4.38046888801178809320e-12 * (((((max6 * max2) * max1) * max7) * max5) * max4));
        if( (r > eps) )
        {
            int_tmp_result_FFWKCAA = 1;
        } 
...
inline int side3_6d_filter( const double* p0, const double* p1, const double* p2, const double* p3, const double* q0, const double* q1, const double* q2) {
    ...
    else 
    {
        ...
        eps = (4.40007476026583916019e-13 * (((max2 * max3) * max1) * max3));
        if( (Delta > eps) )
        {
            int_tmp_result = 1;
        } 
    ...
    else 
    {
        ...
        eps = (1.66564133587113197628e-11 * (((((max5 * max3) * max1) * max7) * max6) * max4));
        if( (r > eps) )
        {
            int_tmp_result_FFWKCAA = 1;
        } 
...
inline int side3_8d_filter( const double* p0, const double* p1, const double* p2, const double* p3, const double* q0, const double* q1, const double* q2) {
    ...
    else 
    {
        ...
        eps = (8.71140112255785451890e-13 * (((max1 * max3) * max2) * max3));
        if( (Delta > eps) )
        {
            int_tmp_result = 1;
        } 
    ...
    else 
    {
        ...
        eps = (4.37492894694731169807e-11 * (((((max5 * max3) * max2) * max7) * max6) * max4));
        if( (r > eps) )
        {
            int_tmp_result_FFWKCAA = 1;
        } 
