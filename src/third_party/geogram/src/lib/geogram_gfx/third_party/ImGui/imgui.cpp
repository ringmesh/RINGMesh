...
bool ImGui::Begin(const char* name, bool* p_open, const ImVec2& size_on_first_use, float bg_alpha, ImGuiWindowFlags flags)
{
    ...
    if (g.SetNextWindowPosCond)
    {
        ...
        // [Bruno Levy] 05/23/2016 this code was triggering a floating point exception, so I replaced FLT_MAX with 1e10
        if (window_pos_set_by_api && ImLengthSqr(g.SetNextWindowPosVal - ImVec2(-1e10f,-1e10f)) < 0.001f)
        {
