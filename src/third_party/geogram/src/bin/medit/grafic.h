...
/* type */
#ifdef WIN32
/* winbase.h defines a macro S_NORMAL which is redefined here with a different semantics.
 * Fortunately medit does not use the Windows S_NORMAL macro, so we can safely undefine it here
 */
#undef S_NORMAL
#endif
