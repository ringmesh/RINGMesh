...
static float colors[MAX_MAT+1][3] = {
  ...
  {0.0f, 0.0f, 0.4f},    /* dark blue */
  {0.0f, 0.4f, 0.0f},    /* dark green */
  {0.4f, 0.0f, 0.0f},    /* dark red */
  {1.0f, 1.0f, 0.5f},
  {1.0f, 0.5f, 1.0f},  
  {1.0f, 0.5f, 0.5f},  
  {1.0f, 0.5f, 0.0f},    /* orange */
...
void matInit(pScene sc) {
  ...
  for (m=0; m<=sc->par.nbmat; m++) {
    ...
    pm->dif[3] = 1.0;
    /* ambient : grey level */
    pm->amb[0] = pm->amb[1] = pm->amb[2] = 0.2f;  pm->amb[3] = 1.0;
    /* emission: null (pas un neon!) */
    pm->emi[0] = pm->emi[1] = pm->emi[2] = 0.0f;  pm->emi[3] = 1.0;
    /* specular: soleil blanc */
    pm->spe[0] = pm->spe[1] = pm->spe[2] = 0.4f;  pm->spe[3] = 1.0;
