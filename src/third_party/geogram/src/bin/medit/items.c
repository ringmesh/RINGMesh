...
void drawAxis(pScene sc,int dim) {
  ...
  if ( mesh->dim == 2 ) {
    ...
    glRasterPos3f(1.02f, 0.0, 0.0);
    glutBitmapCharacter(GLUT_BITMAP_HELVETICA_12,'x');
    glRasterPos3f(0.0, 1.02f, 0.0);
    ...
    glVertex3f(0.95f, 0.01f, 0.0);
    glVertex3f(0.95f, -0.01f, 0.0);
    glVertex3f(1.0, 0.0, 0.0);
    glVertex3f(0.95f, 0.0, 0.01f);
    glVertex3f(0.95f, 0.0, -0.01f);
    glVertex3f(1.0, 0.0, 0.0);
    glEnd();
    glBegin(GL_LINE_STRIP);
    ...
    glVertex3f(0.0, 0.95f, 0.01f);
    glVertex3f(0.0, 0.95f, -0.01f);
    glVertex3f(0.0, 1.0, 0.0);
    glVertex3f(0.01f, 0.95f, 0.0);
    glVertex3f(-0.01f, 0.95f, 0.0);
    glVertex3f(0.0, 1.0, 0.0);
    glEnd();
    glBegin(GL_LINE_STRIP);
    ...
    glVertex3f(0.01f, 0.0, 0.95f);
    glVertex3f(-0.01f, 0.0, 0.95f);
    glVertex3f(0.0, 0.0, 1.0);
    glVertex3f(0.0, 0.01f, 0.95f);
    glVertex3f(0.0, -0.01f, 0.95f);
    glVertex3f(0.0, 0.0, 1.0);
    glEnd();
...
void drawGrid(pScene sc,pMesh mesh) {
  ...
  output3(1.1f,0.0,0.0,"%.2f",mesh->xmax);
  output3(0.0,1.01f,0.0,"%.2f",mesh->ymax);
  output3(0.0,0.0,1.01f,"%.2f",mesh->zmax);
...
void drawHUD(pScene sc) {
  ...
  glLineWidth(1.0f);
  /*UNUSED: xm = sc->par.xs / 2.0f*/;
  /*UNUSED: ym = sc->par.ys / 2.0f*/;
