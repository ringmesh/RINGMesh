...
//            ACTION& action ) const
//        {
//            intersect_recursive( action, 1, 0, mesh_.nb_tetra(), 1, 0, mesh_.nb_tetra() ) ;
//        }
//
//        /**
...
//            vec3 nearest_point ;
//            float64 dist ;
//            return nearest_tet( p, nearest_point, dist ) ;
//        }
//
//        /**
...
//            vec3 nearest_point ;
//            float64 result ;
//            nearest_tet( p, nearest_point, result ) ;
//            return result ;
//        }
//
//    private:
